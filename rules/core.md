...
7. **EVERY PIPELINE PRODUCES AN OBSERVATION.** No exceptions — successes and failures both. The continuous learning loop depends on data volume. (Format and pipeline: `protocols/reflection-protocol.md` § Capture Pipeline Observation, `protocols/autonomous-intelligence.md` § Observation Capture.)
