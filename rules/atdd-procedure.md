...
- `protocols/atdd-procedure.md` — full ATDD cycle (batched RED, mutation gate, audit trail, per-behaviour TDD exceptions). Loaded by `/build-implementation` and `/bug-fix` only; not auto-loaded.
