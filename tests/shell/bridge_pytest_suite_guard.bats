...
@test "test-pytest-suite-guard reports 32 passed, 0 failed" { run bash "$REPO_ROOT/hooks/tests/test-pytest-suite-guard.sh"; echo "$output" | grep -q "32 passed, 0 failed"; }
