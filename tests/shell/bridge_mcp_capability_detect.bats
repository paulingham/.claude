...
@test "test-mcp-capability-detect reports 15 passed, 0 failed" { run bash "$REPO_ROOT/hooks/tests/test-mcp-capability-detect.sh"; echo "$output" | grep -q "15 passed, 0 failed"; }
