...
- The PostToolUse `function-body-check.sh` hook blocks new/changed functions exceeding per-language limits (Ruby > 5, TS/JS > 12 — see `protocols/engineering-invariants.md` § Code Shape); advisory on legacy code
