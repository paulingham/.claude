...
1. **Design brief exists**: Check `$state_dir/{task-id}/design-brief.md` (output from `/harness:creative-direction`). If found, extract: font pairing, palette HSL values, layout archetype, interaction paradigm. This is the primary source — skip to Step 3.
