...
check_rewrite_failed_to_diff "$VAL"
check_phase_a_produces_baseline "$VAL" "$ROOT"
check_phase_b_injects_regressions "$VAL" "$ROOT"
check_phase_c_flags_regressions "$VAL" "$ROOT"
check_phase_d_restores_cleanly "$VAL" "$ROOT"
check_phase_e_clean_verdict "$VAL" "$ROOT"
check_regression_cases_named "$VAL"
check_full_sequence_exit_zero "$VAL"
check_full_sequence_detects_missed_regression "$VAL"
