...
- Any request that names a forcing function from `rules/module-boundaries-protocol.md`
...
Seam enforcement for Phase 4. This table lives here; `rules/module-boundaries-protocol.md` carries only the pointer.
...
- `rules/module-boundaries-protocol.md` — single source of truth for what a module is, module contract artifacts, testing at the seam, the canonical forcing-function list (FF1–FF5), and the decision checklist. Do not duplicate that content here; link to it.
$ARGUMENTS
