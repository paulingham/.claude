...
**Pairing**: security-engineer ships with `executor: claude-sonnet-4-6` and `advisor: claude-opus-4-5-20251101` in its frontmatter. Sonnet drives the OWASP/secrets sweep, Opus is consulted for threat-model and severity-classification calls.
